...
class Settings with ChangeNotifier {
  ...
  void init() async {
    ...
    this._themeData = parseTheme(_prefs.getString('theme')) ?? sunsetTheme;
    ...
    this._profileDesc = _prefs.getString('profileDesc');
    this._profileInterests = _prefs.getString('profileInterests');
  ...
  getProfileDesc() => _profileDesc;
  getProfileInterests() => _profileInterests;


  saveProfileDesc(String desc) async {
    _profileDesc = desc;
    await _prefs.setString('profileDesc', _profileDesc);
    notifyListeners();
  }
  saveProfileInterests(String interests) async {
    _profileInterests = interests;
    await _prefs.setString('profileInterests', _profileInterests);
    notifyListeners();
  }
  ...
  saveChatSession(String chatSession) async {
  ...
  saveChatPeer(String chatPeer) async {
