...
import 'package:major_project/views/pages/profilegame_page/components/red_warrior.dart';
import 'package:major_project/views/pages/profilegame_page/components/slime.dart';
...
class MyGame extends BaseGame  {
  ...
  MyGame(Vector2 widgetSize, BuildContext context) {
    ...
    boundingBox.bottomBound = widgetSize.y - 100;
    spawnPosition = Vector2(widgetSize.x / 15, widgetSize.y /2);
    enemySpawnPosition = Vector2(widgetSize.x * 4 / 5, widgetSize.y *5/8);
    ...
    sword = SpriteComponent.fromImage(Vector2(50,50), Flame.images.fromCache('glowsword.png'));
    ...
    bunny = Bunny(debugAnimation, boundingBox, 1, playerSize/4, spawnPosition*1.7);
  ...
  @override
  void update(t) {
    bunny.enemyPosition = redwarrior.position;
  ...
  addSword(){
    ...
    redwarrior.addChild(this,sword);//i just think it's funny
  }
