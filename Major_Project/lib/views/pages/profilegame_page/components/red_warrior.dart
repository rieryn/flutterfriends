...
class RedWarrior extends SpriteAnimationComponent {
  ...
  double speed = 0.02;
  RedWarrior(SpriteSheet warriorSheet, SpriteAnimation animation,
      BoundingBox boundingBox, Vector2 playerSize, Vector2 spawnPosition)
    ...
    //process spritesheet
    animations = {
      "warriorSpin": warriorSheet.createAnimation(
          row: 0, stepTime: 0.1, to: 4, loop: false),
      'warriorWalkDown': warriorSheet.createAnimation(
          row: 1, stepTime: 0.1, to: 12, loop: false),
      'warriorWalkSideActive': warriorSheet.createAnimation(
          row: 2, stepTime: 0.1, to: 12, loop: false),
      'warriorWalkSidePassive': warriorSheet.createAnimation(
          row: 3, stepTime: 0.1, to: 12, loop: false),
      'warriorWalkUp': warriorSheet.createAnimation(
          row: 4, stepTime: 0.1, to: 12, loop: false),
      'warriorAttackDown': warriorSheet.createAnimation(
          row: 5, stepTime: 0.1, to: 10, loop: false),
      'warriorComboDown': warriorSheet.createAnimation(
          row: 6, stepTime: 0.1, to: 10, loop: false),
      'warriorPowerDown': warriorSheet.createAnimation(
          row: 7, stepTime: 0.1, to: 15, loop: false),
      'warriorAttackSide': warriorSheet.createAnimation(
          row: 8, stepTime: 0.1, to: 10, loop: false),
      'warriorComboSide': warriorSheet.createAnimation(
          row: 9, stepTime: 0.1, to: 10, loop: false),
      'warriorPowerSide': warriorSheet.createAnimation(
          row: 10, stepTime: 0.1, to: 15, loop: false),
      'warriorAttackSideR': warriorSheet.createAnimation(
          row: 11, stepTime: 0.1, to: 10, loop: false),
      'warriorComboSideR': warriorSheet.createAnimation(
          row: 12, stepTime: 0.1, to: 10, loop: false),
      'warriorPowerSideR': warriorSheet.createAnimation(
          row: 13, stepTime: 0.1, to: 15, loop: false),
      'warriorAttackUp': warriorSheet.createAnimation(
          row: 14, stepTime: 0.1, to: 10, loop: false),
      'warriorComboUp': warriorSheet.createAnimation(
          row: 15, stepTime: 0.1, to: 10, loop: false),
      'warriorPowerUp': warriorSheet.createAnimation(
          row: 16, stepTime: 0.1, to: 15, loop: false),
      'warriorFall': warriorSheet.createAnimation(
          row: 17, stepTime: 0.1, to: 5, loop: false),
      'warriorDash': warriorSheet.createAnimation(
          row: 18, stepTime: 0.1, to: 5, loop: false),
      'warriorDashR': warriorSheet.createAnimation(
          row: 19, stepTime: 0.1, to: 5, loop: false),
      'warriorDashUp': warriorSheet.createAnimation(
          row: 20, stepTime: 0.1, to: 5, loop: false),
      'warriorGlowFront': warriorSheet.createAnimation(
          row: 21, stepTime: 0.2, to: 2, loop: false),
      'warriorGlowSide': warriorSheet.createAnimation(
          row: 22, stepTime: 0.1, to: 2, loop: false),
      'warriorGlowSideR': warriorSheet.createAnimation(
          row: 23, stepTime: 0.1, to: 2, loop: false),
      'warriorBlink': warriorSheet.createAnimation(
          row: 24, stepTime: 0.3, to: 13, loop: false),
      'warriorFlourish': warriorSheet.createAnimation(
          row: 25, stepTime: 0.3, to: 15, loop: false),
      'warriorDie': warriorSheet.createAnimation(
          row: 26, stepTime: 2, to: 3, loop: false),
      //type animation for simplicity but flame will convert it to a static sprite
      'warriorDead': warriorSheet.createAnimation(
          row: 26, stepTime: 2, from: 1, to: 2, loop: false),
    };
    //starting animation
    init();
  }
  ...
  void backToStart() {
    ...
    velocity.y -= offset.normalized().y;
  }
  ...
  void boundsCollision() {
    ...
    if (position.x < leftBound) {
      stop();
      position = Vector2(leftBound, position.y);
      bounce(Vector2(1, 0), 0.2, wallBounces);
    }
    if (position.x > rightBound) {
      stop();
      position = Vector2(rightBound, position.y);
      bounce(Vector2(-1, 0), 0.2, wallBounces);
    }
    if (position.y < topBound) {
      stop();
      position = Vector2(position.x, topBound);
      bounce(Vector2(0, 1), 0.1, wallBounces);
    }
    if (position.y > bottomBound) {
      stop();
      position = Vector2(position.x, bottomBound);
      bounce(Vector2(0, -1), 0.1, wallBounces);
    }
  }
